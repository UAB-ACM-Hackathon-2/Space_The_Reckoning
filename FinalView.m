...
- (void) createScene
{
    ...
    score.fontSize = 65;
    score.text = [NSString stringWithFormat:@"Score: %d", HighScore];
    ...
    if (isMLG)
        time.text = [NSString stringWithFormat:@"Doritos Collected: %d", doritoCount];
    else
        time.text = [NSString stringWithFormat:@"Extra Points Collected: %d", doritoCount];
